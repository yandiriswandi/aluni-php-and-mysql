	...
	if($_SESSION["a2_level"] == 'super_user'){
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					...
					<a href="anggota.php"><h4>Data Anggota</h4></a>
					
						<div class="row no-padding"><em class="fa fa-xl fa-address-book color-blue"></em><br></div><br>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
					<a href="tambah_anggota.php"><h4>Tambah Anggota</h4></a>
						<div class="row no-padding"><em class="fa fa-xl fa-clone color-teal"></em><br></div><br>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
					<a href="laporan.php"><h4>Laporan</h4></a>
						<div class="row no-padding"><em class="fa fa-xl fa-bar-chart color-orange"></em><br></div><br>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
					<a href="pengguna.php"><h4>Pengguna</h4></a>
						<div class="row no-padding"><em class="fa fa-xl fa-users color-red"></em><br></div><br>
					</div>
				</div>
			</div>
		</div>
